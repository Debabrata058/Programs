...
<%@page import="cit.admission.Model.Authority_loginModel" %>
...
<%
	HttpSession auth_session = request.getSession();
	Authority_loginModel authModel = (Authority_loginModel)auth_session.getAttribute("authUser");
	if(authModel != null){
%>
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div class="row">
                ...
                <div class="col-md-12"> 
                 <p><b>User Id : <%=authModel.getUid() %></b></p> 
                 <div class="updation">Update Detail</div> 
                 <hr style="margin-top:0px;">
                 <form action="Authority_update">
                 <table>
                 	<tr>
                 	<td>Name*</td>
					<td><input type="text" name="fname" placeholder="FirstName" required> 
					</td>
					<td><input type="text" name="lname" placeholder="LastName" required><br/>
					</td>
					</tr>
					<tr>
					<td>
                    ...
                    <tr>
                    <td>
                    <input type="submit" value="Submit" style="margin-left:60px;margin-top:20px;">
                    </td>
                    </tr>     
                    </table>          
				</form>                
