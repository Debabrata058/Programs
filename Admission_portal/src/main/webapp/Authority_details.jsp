...
<%@page import="cit.admission.Model.Auth_DetailsModel" %>
...
<div class ="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div class="row">
                ...
                <div class="col-md-12"> 
                  <%
	List<Auth_DetailsModel> userlist = (List<Auth_DetailsModel>)request.getAttribute("authList");
	...
	%>
				...
				<table class="table table-striped" style="width:800px;margin-left:70px;margin-top:30px;">
                            ...
                            <tbody>
                            <%
                            for(Auth_DetailsModel details : userlist){
                            %>
                            <tr>
