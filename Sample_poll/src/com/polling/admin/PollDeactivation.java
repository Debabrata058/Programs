...
/**
 * Servlet implementation class PollDeactivation
 */
@WebServlet("/PollDeactivation")
public class PollDeactivation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bean !=  null) {
				...
				boolean stsatus = PollDao.deactivatePoll(pollId);
				if (stsatus == true) {
