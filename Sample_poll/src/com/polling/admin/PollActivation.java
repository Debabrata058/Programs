...
/**
 * Servlet implementation class PollActivation
 */
@WebServlet("/PollActivation")
public class PollActivation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bean !=  null) {
				...
				boolean stsatus = PollDao.activatePoll(pollId);
				if (stsatus == true) {
